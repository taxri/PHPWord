...
INSERT INTO `lime_strategies` VALUES (1,'strg1111',811742,19,'target','st_summary','st_detail','test1','zh-Hans','zh-Hans\n'),(2,'strg2222',811742,19,'ttttt','sssss','dddddd','aaaa','zh-Hans','2222'),(3,'strg3333',811742,20,'ttttttt','ssss','ddddd','aaa','zh-Hans','1'),(4,'strg44444',811742,20,'targettargettargettargettargettargettargettargettargettargettargettargettargettargettargettargettargettargettargettargettargettargettargettargettargettargettargettargettargettargettargettargettargettargettargettargettargettarget','ssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssss','sssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssss','ssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssss','zh-Hans','1'),(5,NULL,811742,0,'targettargettargettargettargettargettargettargettarget','strategy_summarystrategy_summarystrategy_summarystrategy_summarystrategy_summarystrategy_summarystrategy_summarystrategy_summarystrategy_summarystrategy_summarystrategy_summary','strategy_detailstrategy_detailstrategy_detailstrategy_detailstrategy_detailstrategy_detailstrategy_detailstrategy_detailstrategy_detailstrategy_detailstrategy_detailstrategy_detail','otherotherotherotherotherotherotherotherotherother','zh-Hans',''),(6,NULL,811742,0,'targettargettargettargettargettargettargettargettarget','strategy_summarystrategy_summarystrategy_summarystrategy_summarystrategy_summarystrategy_summarystrategy_summarystrategy_summarystrategy_summarystrategy_summarystrategy_summarystrategy_summary','strategy_detailstrategy_detailstrategy_detailstrategy_detailstrategy_detailstrategy_detailstrategy_detailstrategy_detailstrategy_detailstrategy_detail','otherotherotherotherotherotherotherotherother','zh-Hans','');
...
CREATE TABLE `lime_strg_conditions` (
  ...
  `scenario` int(11) NOT NULL DEFAULT '1',
  PRIMARY KEY (`cid`),
  KEY `lime_strg_conditions_idx` (`gid`),
...
#
# Structure for table "lime_tokens_653391"
#

DROP TABLE IF EXISTS `lime_tokens_653391`;
CREATE TABLE `lime_tokens_653391` (
...
#
# Data for table "lime_tokens_653391"
#

/*!40000 ALTER TABLE `lime_tokens_653391` DISABLE KEYS */;
/*!40000 ALTER TABLE `lime_tokens_653391` ENABLE KEYS */;
