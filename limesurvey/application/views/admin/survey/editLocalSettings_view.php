    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-lg-6">
                ...
                <!-- Docx template -->
                <div class="form-group">
                    <label class="control-label "><?php eT("docx template:"); ?></label>
                    <div class="">
                        <?php echo CHtml::textField("tempdocx_{$aSurveyLanguageSettings['surveyls_language']}",$aSurveyLanguageSettings['surveyls_template_docx'],array('class'=>'form-control','size'=>"64",'maxlength'=>128,'id'=>"tempdocx_{$aSurveyLanguageSettings['surveyls_language']}")); ?>
                    </div>
                </div>

                <!-- Docx template suffix -->
                <div class="form-group">
                    <label class="control-label "><?php eT("docx template suffix:"); ?></label>
                    <div class="">
                        <?php echo CHtml::textField("tempdocxsuf_{$aSurveyLanguageSettings['surveyls_language']}",$aSurveyLanguageSettings['surveyls_template_docx_suffix'],array('class'=>'form-control','size'=>"32",'maxlength'=>32,'id'=>"tempdocxsuf_{$aSurveyLanguageSettings['surveyls_language']}")); ?>
                    </div>
                </div>
