...
class SurveyLanguageSetting extends LSActiveRecord
{
    ...
    public function rules()
    {
        return array(
            ...
            array('surveyls_template_docx', 'LSYii_Validators'),
            array('surveyls_template_docx', 'length', 'min' => 0, 'max'=>128),
            array('surveyls_template_docx_suffix', 'LSYii_Validators'),
            array('surveyls_template_docx_suffix', 'length', 'min' => 0, 'max'=>32),
