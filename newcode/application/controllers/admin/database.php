        ...
        if (Permission::model()->hasSurveyPermission($iSurveyID, 'surveylocale', 'update')) {
            foreach ($languagelist as $langname) {
                if ($langname) {
                    ...
                    $sTempDocx = Yii::app()->request->getPost('tempdocx_'.$langname, null);
                    $sTempDocxSuf = Yii::app()->request->getPost('tempdocxsuf_'.$langname, null);
                    ...
                    if ($sTempDocx !== null) {
                        $data['surveyls_template_docx'] = htmlspecialchars($sTempDocx);
                    }

                    if ($sTempDocxSuf !== null) {
                        $data['surveyls_template_docx_suffix'] = htmlspecialchars($sTempDocxSuf);
                    }
