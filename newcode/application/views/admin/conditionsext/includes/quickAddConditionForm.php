<div class="container-fluid">
    <?php echo CHtml::form(array("/admin/conditionsext/sa/index/subaction/{$subaction}/surveyid/{$iSurveyID}/gid/{$gid}/strg_id/{$strg_id}/"),'post',array('id'=>"quick-add-conditions-form",'name'=>"quick-add-conditions-form", 'class' => 'form '));?>
        ...
        <div class="row">
            <div class='form-group '>
                ...
                <div class='col-sm-10'>
                    ...
                    <input type='hidden' name='quick-add-strg_id' value='<?php echo $strg_id; ?>' />
