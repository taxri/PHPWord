    ...
    <div class='panel-heading scenario-heading'>
        ...
        <div class='row'>
            ...
            <div class='col-sm-10'>
                ...
                <?php echo CHtml::form(array("/admin/conditionsext/sa/index/subaction/updatescenario/surveyid/{$surveyid}/gid/{$gid}/strg_id/{$strg_id}/"), 'post', array('style'=>'display: none','id'=>'editscenario'.$scenarionr['scenario']));?>
                    <label>
                ...
                <?php echo CHtml::form(array("/admin/conditionsext/sa/index/subaction/deletescenario/surveyid/{$surveyid}/gid/{$gid}/strg_id/{$strg_id}/"), 'post', array('style'=>'margin-bottom:0;', 'class' => 'delete-scenario-form', 'id'=>'deletescenario'.$scenarionr['scenario'],'name'=>'deletescenario'.$scenarionr['scenario']));?>
