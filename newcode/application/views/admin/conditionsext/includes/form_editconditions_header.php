...
<div class="container-fluid">
    <?php echo CHtml::form(array("/admin/conditionsext/sa/index/subaction/{$subaction}/surveyid/{$iSurveyID}/gid/{$gid}/strg_id/{$strg_id}/"),'post',array('id'=>"editconditions",'name'=>"editconditions", 'class' => 'form'));?>
        <div class="row ">
        <!-- Form  editconditions -->
