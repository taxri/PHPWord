...
<a
    ...
    onclick="$.bsconfirm('<?php eT("Are you sure you want to delete this condition?"); ?>', {'confirm_ok': '<?=gT("Yes")?>', 'confirm_cancel': '<?=gT("No")?>'}, function() {
            ...
            document.getElementById('conditionsext<?php echo $rows['cid']; ?>').submit();
        });"
    >
...
<a
    ...
    onclick='document.getElementById("subaction<?php echo $rows['cid']; ?>").value="editthiscondition"; document.getElementById("conditionsext<?php echo $rows['cid']; ?>").submit();'
>
