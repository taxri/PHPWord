...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-sm-12 col-md-6">
            ...
            <div class="form-group">
                <label class="control-label ">
                    <?php eT("Docx template:"); ?>
                </label>
                <div class="">
                    <?php echo CHtml::textField("tempdocx",$aSurveyLanguageSettings['surveyls_template_docx'],array('class'=>'form-control','size'=>"64",'id'=>"tempdocx")); ?>
                </div>
            </div>
            ...
            <div class="form-group">
                <label class="control-label ">
                    <?php eT("Docx template suffix:"); ?>
                </label>
                <div class="">
                    <?php echo CHtml::textField("tempdocxsuf",$aSurveyLanguageSettings['surveyls_template_docx_suffix'],array('class'=>'form-control','size'=>"32",'id'=>"tempdocxsuf")); ?>
                </div>
            </div>
